  ...
  return (
    <div>
      <div className="flex flex-col gap-2">
        <Text>
          We have now created a few sample products in your Vgang store. You can scroll down to see what the Product Detail view looks like in the Admin dashboard. This is also the view you use to
        ...
        <Text>
          The Next.js Storefront Starter is a template that helps you start building an ecommerce store with Vgang. You control the code for the storefront and you can customize it further to fit your
          specific needs.
        </Text>
