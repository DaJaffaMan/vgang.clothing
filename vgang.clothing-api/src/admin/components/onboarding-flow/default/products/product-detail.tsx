  ...
  return (
    <div>
      <div className="flex flex-col gap-2">
        ...
        <Text>You can preview your product using Vgang's Store APIs. You can copy any of the following code snippets to try it out.</Text>
      </div>
      <div>
        {!isLoading && (
          <CodeBlock
            snippets={[
              ...
              {
                label: "Vgang JS Client",
                language: "js",
                code: `// Install the JS Client in your storefront project: @medusajs/medusa-js\n\nimport Vgang from "@medusajs/medusa-js"\n\nconst medusa = new Vgang(${
