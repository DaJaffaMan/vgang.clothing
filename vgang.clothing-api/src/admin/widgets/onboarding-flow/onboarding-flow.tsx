...
import { AdminOnboardingUpdateStateReq, OnboardingStateRes, UpdateOnboardingStateInput } from "../../../types/onboarding";
...
type STEP_ID = "create_product" | "preview_product" | "create_order" | "setup_finished" | "create_product_nextjs" | "preview_product_nextjs" | "create_order_nextjs" | "setup_finished_nextjs";
...
const OnboardingFlow = (props: OnboardingWidgetProps) => {
  ...
  const setStepComplete = ({ step_id, extraData, onComplete }: { step_id: STEP_ID; extraData?: UpdateOnboardingStateInput; onComplete?: () => void }) => {
      ...
      switch (process.env.MEDUSA_ADMIN_ONBOARDING_TYPE) {
        ...
        default:
          return [
            ...
            {
              id: "setup_finished",
              title: "Setup Finished: Start developing with Vgang",
  ...
  const getStartedText = () => {
    switch (process.env.MEDUSA_ADMIN_ONBOARDING_TYPE) {
      case "nextjs":
        return "Learn the basics of Vgang by creating your first order using the Next.js storefront.";
      default:
        return "Learn the basics of Vgang by creating your first order.";
    }
  };
              ...
              <>
                <div>
                  ...
                  <Text>
                    ...
                    <a href="https://docs.medusajs.com/admin/onboarding?ref=onboarding" target="_blank" className="text-blue-500 font-semibold">
                      our guide
                    </a>
                    .
                  </Text>
                ...
                return (
                  ...
                  >
                    <div className="pl-14 pb-6 pr-7">
                      <step.component onNext={step.onNext} isComplete={isComplete} data={data?.status} {...props} />
                    </div>
                  </Accordion.Item>
                );
              })}
